...
export class SlidersService {
  ...
  listSliders(page: number = 1, search: string) {
    ...
    const URL =
      URL_SERVICE + '/admin/sliders?page=' + page + '&search=' + search;
    return this.http
  ...
  createSliders(data: any) {
    ...
    const URL = URL_SERVICE + '/admin/sliders';
    return this.http
  ...
  showSlider(slider_id: string) {
    ...
    const URL = URL_SERVICE + '/admin/sliders/' + slider_id;
    return this.http
      .get(URL, { headers: headers })
      .pipe(finalize(() => this.isLoadingSubject.next(false)));
  }
  ...
  updateSliders(slider_id: string, data: any) {
    ...
    const URL = URL_SERVICE + '/admin/sliders/edit/' + slider_id;
    return this.http
      .post(URL, data, { headers: headers })
      .pipe(finalize(() => this.isLoadingSubject.next(false)));
  }
